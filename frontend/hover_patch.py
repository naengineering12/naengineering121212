...
# Rebuild service artwork directly into App.js at build time. These are inline SVGs,
# so the service listing and service detail pages never depend on external image URLs.
art = {
    "civil-engineering": '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 900"><rect width="1200" height="900" fill="#07112f"/><path d="M120 690h960M190 690V350l160-120 160 120v340M690 690V300l170-110 160 110v390" fill="none" stroke="#ffb15c" stroke-width="18"/><text x="70" y="110" fill="#fff" font-family="Arial" font-size="52" font-weight="700">CIVIL ENGINEERING</text></svg>''',
    "hvac": '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 900"><rect width="1200" height="900" fill="#07112f"/><g fill="none" stroke="#fff" stroke-width="22"><path d="M160 300h880v170H160zM260 470v210M940 470v210M330 300V190h540v110"/></g><path d="M470 555h260" stroke="#ffb15c" stroke-width="28"/><text x="70" y="110" fill="#fff" font-family="Arial" font-size="52" font-weight="700">HVAC SYSTEMS</text></svg>''',
    "mechanical-engineering": '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 900"><rect width="1200" height="900" fill="#07112f"/><circle cx="600" cy="470" r="210" fill="none" stroke="#ffb15c" stroke-width="35"/><circle cx="600" cy="470" r="80" fill="none" stroke="#fff" stroke-width="28"/><path d="M600 230v-90M600 700v90M360 470h-90M840 470h90" stroke="#fff" stroke-width="24"/><text x="70" y="110" fill="#fff" font-family="Arial" font-size="48" font-weight="700">MECHANICAL ENGINEERING</text></svg>''',
    "peb-works": '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 900"><rect width="1200" height="900" fill="#07112f"/><path d="M130 700h940M190 700V360l410-220 410 220v340M360 700V430h480v270" fill="none" stroke="#ffb15c" stroke-width="22"/><path d="M600 140v560" stroke="#fff" stroke-width="16"/><text x="70" y="105" fill="#fff" font-family="Arial" font-size="52" font-weight="700">PEB WORKS</text></svg>''',
    "electrical-works": '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 900"><rect width="1200" height="900" fill="#07112f"/><g fill="none" stroke="#ffb15c" stroke-width="18"><path d="M150 690h900M220 690V310l160-110 160 110v380M730 690V270l170-90 170 90v420"/></g><g fill="#fff"><rect x="300" y="370" width="70" height="120" rx="8"/><rect x="450" y="370" width="70" height="120" rx="8"/><rect x="790" y="340" width="70" height="120" rx="8"/><rect x="940" y="340" width="70" height="120" rx="8"/></g><path d="M590 300l-80 190h75l-40 120 150-220h-80z" fill="#ffb15c"/><text x="70" y="110" fill="#fff" font-family="Arial" font-size="52" font-weight="700">ELECTRICAL WORKS</text></svg>''',
    "fire-fighting": '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 900"><rect width="1200" height="900" fill="#07112f"/><path d="M510 650h180V300H510zM540 300v-70h120v70" fill="#ffb15c"/><path d="M690 360h90v120" fill="none" stroke="#fff" stroke-width="22"/><path d="M600 190c-70 70-85 125-35 175 20-55 55-70 70-115 45 55 55 105 10 155 90-25 105-110 35-215-20 50-45 70-80 0z" fill="#fff"/><text x="70" y="110" fill="#fff" font-family="Arial" font-size="52" font-weight="700">FIRE FIGHTING</text></svg>''',
    "safety-security": '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 900"><rect width="1200" height="900" fill="#07112f"/><path d="M310 650h580" stroke="#fff" stroke-width="18"/><path d="M380 650V420h440v230" fill="none" stroke="#ffb15c" stroke-width="18"/><path d="M410 420c10-115 80-185 190-185s180 70 190 185H410z" fill="#ffb15c"/><path d="M470 420h260" stroke="#07112f" stroke-width="24"/><path d="M250 650h80M870 650h80" stroke="#ffb15c" stroke-width="30"/><path d="M930 480l80 80-80 80" fill="none" stroke="#fff" stroke-width="18"/><text x="70" y="105" fill="#fff" font-family="Arial" font-size="50" font-weight="700">SAFETY &amp; SECURITY</text><text x="72" y="155" fill="#c9d6e6" font-family="Arial" font-size="25">HELMETS • PPE • FACILITY SAFETY</text></svg>'''
}
...
print("Service artwork rebuilt as inline SVG; no external image requests are used for service cards or service detail pages.")
