...
old_nav = "const nav=[['Home','/'],['Services','/services'],['Engineering Supplies & Services','/engineering-supplies-services'],['General Order Supplies','/supplies'],['Industries','/industries'],['Our Clients','/clients'],['Contact','/contact']];"
...
old_nav_original = "const nav=[['Home','/'],['Services','/services'],['General Order Supplies','/supplies'],['Industries','/industries'],['Our Clients','/clients'],['Contact','/contact']];"
source = source.replace(old_nav_original, new_nav, 1)

marker = "function Supplies(){"
page = r'''function ITServices(){const groups=[
{title:"IT Infrastructure & Networking",icon:Network,image:"https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=1200&q=75",text:"Network design, structured cabling, switches, routers, Wi-Fi, racks and practical infrastructure support for offices and industrial sites."},
{title:"CCTV & Surveillance",icon:Camera,image:"https://images.unsplash.com/photo-1557597774-9d273605dfa9?auto=format&fit=crop&w=1200&q=75",text:"CCTV cameras, recording systems, monitoring and surveillance solutions designed around site coverage, security and operational needs."},
{title:"Access Control",icon:LockKeyhole,image:"https://images.unsplash.com/photo-1558008258-3256797b43f3?auto=format&fit=crop&w=1200&q=75",text:"Door access systems, biometric devices, RFID solutions and controlled-entry setups for offices, facilities and restricted areas."},
{title:"Computer & Laptop Supply",icon:Laptop,image:"https://images.unsplash.com/photo-1496181133206-80ce9b88a853?auto=format&fit=crop&w=1200&q=75",text:"Business computers, laptops, workstations and accessories supplied according to user requirements, performance needs and budget."},
{title:"Printers & Scanners",icon:Printer,image:"https://images.unsplash.com/photo-1612815154858-60aa4c59eaa6?auto=format&fit=crop&w=1200&q=75",text:"Office printers, scanners, multifunction devices, consumables and related support for reliable day-to-day document handling."},
{title:"Servers & Storage",icon:Server,image:"https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=1200&q=75",text:"Server hardware, storage, backup equipment and infrastructure support for businesses that need dependable data and system availability."},
{title:"Software & IT Support",icon:Code2,image:"https://images.unsplash.com/photo-1515879218367-8466d910aaa4?auto=format&fit=crop&w=1200&q=75",text:"Software setup, user support, troubleshooting, system configuration and practical IT assistance for everyday business operations."},
{title:"IT Hardware & All Accessories",icon:HardDrive,image:"https://images.unsplash.com/photo-1593640408182-31c70c8268f5?auto=format&fit=crop&w=1200&q=75",text:"Keyboards, mice, monitors, UPS units, cables, adapters, networking accessories, storage devices and other IT hardware."},
{title:"Annual Maintenance / Technical Support",icon:Wrench,image:"https://images.unsplash.com/photo-1581092921461-eab62e97a780?auto=format&fit=crop&w=1200&q=75",text:"Planned maintenance, troubleshooting and technical support to keep workplace IT systems available, organised and performing reliably."}
