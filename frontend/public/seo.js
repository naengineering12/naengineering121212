(function () {
  ...
  function apply() {
    ...
    schema.textContent = JSON.stringify({
      ...
      address: {
        '@type': 'PostalAddress',
        streetAddress: '593 Block-A LDA Avenue, 1 Raiwind Rd',
      ...
      sameAs: [
        'https://www.tiktok.com/@na_engineering.co',
        'https://www.instagram.com/na_engineering.co/',
        'https://x.com/NA_engsolutions'
      ]
    });
  }
